...
export async function action({ request }: Route.ActionArgs) {
  ...
  if (!name || !email || !password || !confirmPassword) {
    return { error: "সমস্ত প্রয়োজনীয় ঘর পূরণ করা আবশ্যক।" };
  }

  if (password !== confirmPassword) {
    return { error: "পাসওয়ার্ড ও নিশ্চিতকরণ পাসওয়ার্ড মিলছে না।" };
  }
  ...
  if (existingUser) {
    return { error: "এই ইমেইল এড্রেস দিয়ে ইতোমধ্যে একটি একাউন্ট তৈরি করা আছে।" };
  }
  ...
  // Auto provision default categories and cash wallet for new user
  await provisionNewUserDefaults(user.id);
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  name="password"
                  required
                  placeholder="অত্যন্ত ৬ অক্ষরের পাসওয়ার্ড"
